...
class EmployerFilterOptions extends ConsumerStatefulWidget {
  final Map<String, dynamic>? initialValues;
  const EmployerFilterOptions({super.key, this.initialValues});

  @override
  ConsumerState<EmployerFilterOptions> createState() =>
      _EmployerFilterOptionsState();
}

class _EmployerFilterOptionsState extends ConsumerState<EmployerFilterOptions> {
  @override
          ...
          children: [
            ...
            CustomButton(
              ...
              onPressed: () async {
                ...
                await vm.fetchEmployersDetails();
